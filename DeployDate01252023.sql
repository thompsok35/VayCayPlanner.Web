...
BEGIN
    ...
    VALUES (N'20221229020256_deletedallmigrations', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221229181242_changes to travelgroup and traveler', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221229181501_Removed travelgroupid reference', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221230164100_changed the baseentity travelgroupid to a int', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230114154628_Updated destinations, trips. Added onboarding and onboardingsteps', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230115160310_removed the FK to travelgroup from subscriber', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230115183614_added newtriptemplate and modified destinations', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230115185215_made all properties nullable in newtriptemplate', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230115195058_added email and fullname to newtriptemplate', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230115203146_added more bools to track the create trip process made isComplete nullable', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230117020013_updated triptemplate', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230117021415_updated triptemplate with all date properties nullable and arrivaldate', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230122233343_added the DestinationTraveler data model', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230123140950_changed the name of the destination travelers', N'6.0.12');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230125024217_updated the TravelerDestinations table', N'6.0.12');
END;
GO
